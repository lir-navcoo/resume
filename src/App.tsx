...
const resumeData = {
  ...
  experience: [
    { company: '安徽霍迹寻踪科技有限公司', period: '2022.10 – 至今', role: '解决方案中心经理', description: '从 0 到 1 建立霍迹寻踪解决方案体系，主导技术架构设计，负责售前咨询与客户需求梳理，带领团队完成多个大型项目交付（其中阳光电源接待服务平台 1-4 期即为任期内主导签约落地）。负责客户成功全链路管理。', tags: [], achievement: '2023年1月获公司合伙人荣誉；完成霍迹寻踪客户成功体系建设，构建交付、运维一体化闭环链路，任职期间完成钉钉宜搭交付体系从 0 到 1 建设，完成霍迹寻踪与钉钉宜搭核心代理的建立。' },
