...
const resumeData = {
  ...
  experience: [
    { company: '安徽霍迹寻踪科技有限公司', period: '2022.10 – 至今', role: '解决方案中心经理', description: '从 0 到 1 建立霍迹寻踪解决方案体系，主导技术架构设计，负责售前咨询与客户需求梳理，带领团队完成多个大型项目交付（其中阳光电源接待服务平台 1-4 期即为任期内主导签约落地）。负责客户成功全链路管理。', tags: [], achievement: '2024年10月因业务变动调岗至大客户 CSM，服务企业包括阳光电源、丽豪清能、立方制药、济川药业、天准科技、卓朗智能等。' },
