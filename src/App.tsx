...
const resumeData = {
  ...
  projects: [
    { name: '阳光电源接待服务平台（1-4期）', tech: '钉钉宜搭（低代码平台）', description: '全量闭环阳光电源接待部门日常业务管理，涵盖会议接待、用餐接待、展厅接待等模块，打通公众号完成阳光电源对协议酒店、餐厅等管理。', link: '' },
    { name: '阳光电源访客中心平台（1-3期）', tech: '钉钉宜搭 + 微信小程序 + Exchange', description: '通过钉钉宜搭实现阳光电源个性化访客管理，微信小程序实现访客端认证，接入 Exchange 实现对外国友人的访客邀请和预约。', link: '' },
    { name: '安徽财经大学低代码微专业', tech: '钉钉宜搭 + 教学', description: '担任安徽财经大学外聘讲师，主讲低代码微专业核心课程，该项目为公开信息（可网络查询）。', link: '' },
  ],
        ...
        <div className="flex items-start gap-5">
          ...
          <div>
            ...
            <a
              ...
              className="inline-flex items-center gap-1.5 mt-3 text-xs px-3 py-1.5 rounded-lg border transition-all duration-200 hover:opacity-80"
